...
<body>
			...
			<div class="loginForm">
				<s:form namespace="/" action="login" id="loginform" name="loginform" method="post" cssClass="niceform" target="_top">
					...
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						...
						<s:textfield id="loginform:idInput" type="text" name="username"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							...
							<s:textfield id="loginform:codeInput" class="loginFormTdIpt" type="text"
	...
	<div
		...
		<span style="color: #488ED5;">Powered By www.pdm.top</span><span
